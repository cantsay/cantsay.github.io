...
function getDamageResult(attacker, defender, move, field) {
  ...
  if (move.name === "Synchronoise" && [defender.type1, defender.type2].indexOf(attacker.type1) === -1 && [defender.type1, defender.type2].indexOf(attacker.type2) === -1) {
    return {
      "damage": [0],
      "description": buildDescription(description)
    };
  ...
  ////////////////////////////////
  var defense;
  var hitsPhysical = move.category === "Physical" || move.overrideDefensiveStat === "def";
...
function getFlingPower(item) {
  return item === "Iron Ball" ? 130 :
    item === "Hard Stone" ? 100 :
    item.indexOf("Plate") !== -1 || ["Deep Sea Tooth", "Thick Club"].indexOf(item) !== -1 ? 90 : ["Assault Vest", "Weakness Policy"].indexOf(item) !== -1 ? 80 : ["Poison Barb", "Dragon Fang"].indexOf(item) !== -1 ? 70 : ["Adamant Orb", "Lustrous Orb", "Macho Brace", "Stick"].indexOf(item) !== -1 ? 60 :
    item === "Sharp Beak" ? 50 :
    item === "Eviolite" ? 40 : ["Black Belt", "Black Sludge", "Black Glasses", "Charcoal", "Deep Sea Scale", "Flame Orb", "King's Rock",
      "Life Orb", "Light Ball", "Magnet", "Metal Coat", "Miracle Seed", "Mystic Water", "Never-Melt Ice",
      "Razor Fang", "Soul Dew", "Spell Tag", "Toxic Orb", "Twisted Spoon"
    ].indexOf(item) !== -1 ? 30 :
    10;
}
